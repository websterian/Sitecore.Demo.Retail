//-----------------------------------------------------------------------
// <copyright file="LoyaltyRewardPointItemBaseApiModel.cs" company="Sitecore Corporation">
//     Copyright (c) Sitecore Corporation 1999-2016
// </copyright>
// <summary>Defines the LoyaltyRewardPointItemBaseApiModel class.</summary>
//-----------------------------------------------------------------------
...
namespace Sitecore.Feature.Commerce.Customers.Models
{
    ...
    /// </summary>
    public class LoyaltyRewardPointItemBaseApiModel : BaseApiModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoyaltyRewardPointItemBaseApiModel"/> class.
        /// </summary>
        public LoyaltyRewardPointItemBaseApiModel()
            : base()
        {
            this.Transactions = new List<LoyaltyTransactionItemBaseApiModel>();
        }
        ...
        public LoyaltyRewardPointItemBaseApiModel(ServiceProviderResult result)
            : base(result)
        {
            this.Transactions = new List<LoyaltyTransactionItemBaseApiModel>();
        }
        ...
        /// The transactions.
        /// </value>
        public List<LoyaltyTransactionItemBaseApiModel> Transactions { get; protected set; }
        ...
        public virtual void Initialize(LoyaltyRewardPoint rewardPoint)
        {
            ...
            {
                var result = new LoyaltyTransactionItemBaseApiModel();
