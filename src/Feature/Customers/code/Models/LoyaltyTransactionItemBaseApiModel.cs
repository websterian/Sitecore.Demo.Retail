//-----------------------------------------------------------------------
// <copyright file="LoyaltyTransactionItemBaseApiModel.cs" company="Sitecore Corporation">
//     Copyright (c) Sitecore Corporation 1999-2016
// </copyright>
// <summary>Defines the LoyaltyTransactionItemBaseApiModel class.</summary>
//-----------------------------------------------------------------------
...
namespace Sitecore.Feature.Commerce.Customers.Models
{
    ...
    /// </summary>
    public class LoyaltyTransactionItemBaseApiModel
    {
        /// <summary>
