//-----------------------------------------------------------------------
// <copyright file="WishListItemBaseApiModel.cs" company="Sitecore Corporation">
//     Copyright (c) Sitecore Corporation 1999-2016
// </copyright>
// <summary>Defines the WishListItemBaseApiModel class.</summary>
//-----------------------------------------------------------------------
...
namespace Sitecore.Feature.Commerce.Customers.Models
{
    ...
    /// </summary>
    public class WishListItemBaseApiModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WishListItemBaseApiModel" /> class.
        /// </summary>
        /// <param name="line">The line.</param>
        /// <param name="wishListId">The wish list identifier.</param>
        public WishListItemBaseApiModel(WishListLine line, string wishListId)
        {
            ...
            if (imageInfo != null)
            {
                ...
                this.Image = mediaItem.ImageUrl(100, 100);
            }
