//-----------------------------------------------------------------------
// <copyright file="UpdateWishListInputModel.cs" company="Sitecore Corporation">
...
namespace Sitecore.Foundation.Commerce.Models.InputModels
{
    ...
    /// <summary>
    /// Defines the UpdateWishListInputModel class.
    /// </summary>
    public class UpdateWishListInputModel
    {
        /// <summary>
