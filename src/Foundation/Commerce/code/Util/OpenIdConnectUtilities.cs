...
namespace Sitecore.Foundation.Commerce.Util
{
    ...
    public static class OpenIdConnectUtilities
    {
        ...
        /// </summary>
        public const string CookieCurrentProviderType = "oidcpt";

        /// <summary>
        /// Cookie name used for the open id cookie
        /// </summary>
        public const string OpenIdCookie = "oidc";
        ...
        public const int SignedInCookieDurationInMinutes = 61;
        ...
        public static System.Configuration.Configuration DynamicsConnectorConfiguration
        {
            get
            {
        ...
        public static string ExecuteRequest(HttpWebRequest req)
        {
            try
            {
        ...
        public static string ValidateRequestAndGetAuthorizationCode()
        {
        ...
        public static string GetAcsToken(string queryString)
        {
        ...
        public static void SetTokenCookie(string idToken)
        {
            HttpCookie ck;
